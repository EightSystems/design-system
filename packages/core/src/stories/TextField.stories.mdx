...
<Canvas>
    <Story
        ...
        args={{ name: "inputName", label: "Input Label Disabled", disabled: true, placeholder: "Disabled value" }}
    >
        {args => <TextField {...args} />}
    </Story>
</Canvas>
...
<Canvas>
    <Story
        ...
        args={{ name: "inputName", label: "Input Label", value: "Right Input", icon: "success", validationSuccess: true }}
    >
        {args => <TextField {...args} />}
    </Story>
</Canvas>
